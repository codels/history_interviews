 ...
 * 2. точка в пространстве имеет 3 координаты (x, y, z), которыми являются свойства лица
 *
 ...
 * возможно на сотнях тысячах и миллионах алгоритмы лучше выбирать чем на 10000, если мы конечно
 * рассматриваем большие задачи. Я пытался уложиться в короткий срок из-за собеседований. Если
 * нужно устранить все логические ошибки и покрыть тестами и установить замеры, напишите отдельно
 * возможно мне нет смысла терять время улучшая данный алгоритм, если понятно что и как в целом.
 *
